    ...
    return (
        <>
            <div className=" bg-black text-white p-5">
                <div className="m-2">
                    <h1 className="capitalize text-center text-4xl font-medium">stay tuned with us</h1>
                ...
                <div className="m-6">
                    <div className="my-4">
                        <h1 className="text-4xl text-center font-medium capitalize">our key contacts</h1>
                    </div>
                    <div className="flex flex-wrap justify-center gap-6 md:gap-40">
                ...
                <div className="flex flex-wrap justify-center items-center text-center gap-6 p-4">
                    <div className="w-96 ">
                        <h1 className="text-2xl text-blue-400 uppercase ">Saudi Arabia </h1>
                        <p> P.O.Box:4535 <br />
                    ...
                    <div className="w-96">
                        <h1 className="text-2xl text-blue-400 uppercase ">U.A.E</h1>
                        <p>P.O.Box 242808 <br />
                            Al Abbas Building
                    ...
                    <div className="w-96">
                        <h1 className="text-2xl text-blue-400 uppercase ">Bahrain</h1>
                        <p> P.0.Box 5017 <br />
                            Exhibition Road, Manama, Kingdom of Bahrain. <br />
                            Telefax: +973 17292877</p>
                    </div>
                    <div className="w-96">
                        <h1 className="text-2xl text-blue-400 uppercase ">India </h1>
                        <p>60/478 2nd Floor,
                            Kolathara Arcade,<br />
