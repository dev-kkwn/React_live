import petro1 from "../assests/petro-card-1.jpg";
import petro2 from "../assests/petro-card-2.jpg";
import petro3 from "../assests/petro-card-3.jpg";
...
export function Petrochem() {
  return (
    <>
      <section className="">
        <div className="context-kk-petro-banner md:flex justify-start items-center w-full">
